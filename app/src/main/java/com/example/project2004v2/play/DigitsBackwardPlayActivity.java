...
public class DigitsBackwardPlayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_digits_backward_play);
        ...
        btnGoBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DigitsBackwardPlayActivity.this, DigitsBackwardActivity.class);
    ...
    private void checkAnswer() {
        ...
        Collections.sort(sortedSequence, Collections.reverseOrder());
